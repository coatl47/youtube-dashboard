...
st.markdown(
    ...
    .st-key-top_controls { width:100%!important; max-width:none!important; margin:0; }
    .st-key-top_controls [data-testid="stTextInput"] { flex:1 1 0!important; min-width:0!important; width:auto!important; }
    .st-key-top_controls [data-testid="stButton"] { flex:0 0 84px!important; width:84px!important; min-width:84px!important; }
    .st-key-top_controls [data-testid="stButton"] button { width:84px!important; min-height:48px; padding:0 12px; font-size:.74rem; white-space:nowrap; }
...
with st.container(
    key="top_controls", width="stretch", horizontal=True,
    horizontal_alignment="left", vertical_alignment="center", gap="xsmall",
):
    ...
    run_analysis = st.button("분석", type="primary", width=84, key="analyze_button")
